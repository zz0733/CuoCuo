(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/hall/script/comm/TestLog.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3efab4ScxhA9LGxdT237iZk', 'TestLog', __filename);
// hall/script/comm/TestLog.js
...
TestLog.stack = function (index) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (lineBreak.length < 2) {
            ...
            result.push(_defineProperty({}, lineBreak[0], lineBreak[1]));
        }
    }
    var list = [];
