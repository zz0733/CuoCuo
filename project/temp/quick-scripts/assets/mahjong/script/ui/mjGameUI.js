(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/mahjong/script/ui/mjGameUI.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '9a96exZlipN0bvKdDvfeIoV', 'mjGameUI', __filename);
// mahjong/script/ui/mjGameUI.js
...
cc.Class({
    ...
    onViewChange: function onViewChange() {
        var is3DView = cc.sys.localStorage.getItem("mjEyeView") == "3D";
    ...
    setCurPaiDirection: function setCurPaiDirection(dir) {
        var setDirectVisi = function () {
            var dirName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "dong";
    ...
    newRound: function newRound() {
        var roundData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    netDelayTime: function netDelayTime(time) {
        ...
        if (this._state) {
            if (this._state === state.rgb) return;else this._state = state.rgb;
        } else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=mjGameUI.js.map
