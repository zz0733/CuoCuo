(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/poker/DDZ/Script/Replay/DDZ_ReplayMain.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e83d6+zmkNDoLBCAuSyMvZP', 'DDZ_ReplayMain', __filename);
// poker/DDZ/Script/Replay/DDZ_ReplayMain.js
...
cc.Class({
    ...
    initSelfHandPoker: function initSelfHandPoker(list, isDiZhu) {
        ...
        for (var i = 0; i < this.selfPlayerHandPoker.length; i++) {
            ...
            if (isDiZhu == true && i == this.selfPlayerHandPoker.length - 1) {
    ...
    initLeftHandPoker: function initLeftHandPoker(list, isDiZhu) {
        ...
        for (var i = 0; i < this.leftPlayerHandPoker.length; i++) {
            ...
            if (isDiZhu == true && i == this.leftPlayerHandPoker.length - 1) {
                pokerNode.getChildByName("OwnerSign").active = true;
            } else {
                pokerNode.getChildByName("OwnerSign").active = false;
            }
    ...
    initSelfOutPoker: function initSelfOutPoker(list, num, isPass) {
        if (list) {
            ...
            for (var i = 0; i < temp.length; i++) {
                ...
                if (this.selfIsDiZhu == true && i == temp.length - 1) {
                    pokerNode.getChildByName("OwnerSign").active = true;
                } else {
                    pokerNode.getChildByName("OwnerSign").active = false;
                }
    ...
    initLeftOutPoker: function initLeftOutPoker(list, num, isPass) {
        ...
        if (list) {
            ...
            for (var i = 0; i < temp.length; i++) {
                ...
                if (this.leftIsDiZhu == true && i == temp.length - 1) {
                    pokerNode.getChildByName("OwnerSign").active = true;
                } else {
                    pokerNode.getChildByName("OwnerSign").active = false;
                }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=DDZ_ReplayMain.js.map
