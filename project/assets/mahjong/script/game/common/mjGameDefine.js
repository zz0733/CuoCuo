...
GameDefine.CREATROOMSC = {
	...
	FengDing: {
		name: '封顶',
		data: { 3: '3番', 4: '4番', 5: '5番', 0: '不封顶' }
	},
	DiFen: {
		name: '底分',
		data: { 1: '1分', 2: '2分', 5: '5分', 10: '10分' }
	},
	FangFei: {
		name: '房费',
		data: { 1: '房主支付', 2: '赢家支付', 3: '平摊支付' }
	},
	GuiZe: {
		name: '规则',
		data: { 1: '呼叫转移', 2: '带幺九', 3: '断幺九', 4: '门前清', 5: '天地胡', 6: '海底捞', 7: '将对' }
	},
	JuShu: {
		name: '局数',
		data: { 4: '4局', 8: '8局', 16: '16局', 32: '32局' }
	},
	DingWei: {
		name: '定位',
		data: { 0: '未开启定位', 1: '已开启定位' }
	},
}
...
GameDefine.CHATCOMMONTEXT = [
	{id:201, content:"快点嘛！又少打两把了！"},
	{id:202, content:"稍等一下，我想想打哪张牌！"},
	{id:203, content:"你们小心点，我听牌了！"},
	{id:204, content:"不要走！决战到天亮！"},
	{id:205, content:"你这牌打得也太好了！"},
	{id:206, content:"等下，我上个厕所！"},
	{id:207, content:"好久都没胡过牌了！"},
	{id:208, content:"今天的手气太差了，输惨了！"},
];

GameDefine.CHATCOMMONEMOJI = [
	{id:101, content:"bishi"},
	{id:102, content:"fadai"},
	{id:103, content:"han"},
	{id:104, content:"jianxiao"},
	{id:105, content:"ku"},
	{id:106, content:"kubile"},
	{id:107, content:"kuxiao"},
	{id:108, content:"shengqi"},
	{id:109, content:"tu"},
	{id:110, content:"wabishi"},
	{id:111, content:"yun"},
	{id:112, content:"zan"},
];

GameDefine.CHATINTERACT = [
	{id:1, nodeName:"liwu2", animaName:"Hua"},
	{id:2, nodeName:"liwu1",animaName:"Jidan"},
	{id:3, nodeName:"liwu1",animaName:"Tuoxie"},
	{id:4, nodeName:"liwu2",animaName:"Wen"},
];
